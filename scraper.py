#!/usr/bin/env python3
"""
Telegram Scraper - Scrape Telegram channels, messages, groups without API
Open source scraper for telegram scraper, scrape telegram, telegram channel scraper
...
class TelegramScraperScraper:
    """Scraper for Telegram Scraper."""
...
def main():
    parser = argparse.ArgumentParser(description="Telegram Scraper - Scrape Telegram channels, messages, groups without API")
    ...
    scraper = TelegramScraperScraper(proxy=args.proxy)
