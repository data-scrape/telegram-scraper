...
> Scrape Telegram channels, messages, groups without API

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue?style=flat-square&logo=python)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/data-scrape/telegram-scraper?style=flat-square)](https://github.com/data-scrape/telegram-scraper)
[![Forks](https://img.shields.io/github/forks/data-scrape/telegram-scraper?style=flat-square)](https://github.com/data-scrape/telegram-scraper/forks)
...
**Telegram Scraper** is a free, open-source Python scraper for **Telegram**. Extract structured data from telegram with full pagination support, proxy rotation, and multiple export formats.

telegram scraper, scrape telegram, telegram channel scraper

## ✨ Features

- ✅ Channel message extraction
- ✅ Group chat scraping
- ✅ User info & member lists
- ✅ Media attachment URLs
- ✅ Forward & reply parsing
...
```bash
git clone https://github.com/data-scrape/telegram-scraper.git
cd telegram-scraper
...
```bash
python scraper.py "@durov channel last 100 messages"
```
...
`message_id` | `text` | `sender_name` | `sender_id` | `channel_name` | `message_type` | `created_at` | `views` | `forwards` | `replies` | `media_url` | `reply_to`

## 💡 Use Cases

- Channel monitoring & analytics
- Group discussion archiving
